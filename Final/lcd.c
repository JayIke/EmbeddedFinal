...
uint8_t lcd_drawRadar(void){
	uint8_t result;
	result = lcd_fillCircle(64,58,5,WHITE);
	result = lcd_drawCircle(64,53,10,WHITE);
	result = lcd_drawCircle(64,43,20,WHITE);
	result = lcd_drawCircle(64,33,30,WHITE);
	//result = lcd_drawRect(105,43,127,1,WHITE);
